...
public class Code2 {
    public static void main(String[] args) {
        ...
        String accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNjkxODUyNTM3LCJleHAiOjE2OTQ0NDQ1Mzd9.oYqnScS2tY0BEepHGjZX7s6EwTT1BOKLmyQ41C7CXvc";
        ...
        try {
            ...
            HttpPost uploadFile = new HttpPost(apiUrl + "/your-content-type-endpoint");
